...
CREATE TABLE `ESTABELECIMENTO` (
  ...
  KEY `idx_ETB_LOCALIDADE` (`loc_id`),
  CONSTRAINT `fk_ESTABELECIMENTO_LOCALIDADE` FOREIGN KEY (`loc_id`) REFERENCES `LOCALIDADE` (`loc_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
