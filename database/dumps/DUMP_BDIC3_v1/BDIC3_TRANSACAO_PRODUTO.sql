...
--
-- Table structure for table `TRANSACAO_PRODUTO`
--
...
--
-- Dumping data for table `TRANSACAO_PRODUTO`
--

LOCK TABLES `TRANSACAO_PRODUTO` WRITE;
/*!40000 ALTER TABLE `TRANSACAO_PRODUTO` DISABLE KEYS */;
/*!40000 ALTER TABLE `TRANSACAO_PRODUTO` ENABLE KEYS */;
UNLOCK TABLES;
