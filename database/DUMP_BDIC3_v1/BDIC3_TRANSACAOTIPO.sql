...
--
-- Table structure for table `TRANSACAOTIPO`
--
...
--
-- Dumping data for table `TRANSACAOTIPO`
--

LOCK TABLES `TRANSACAOTIPO` WRITE;
/*!40000 ALTER TABLE `TRANSACAOTIPO` DISABLE KEYS */;
/*!40000 ALTER TABLE `TRANSACAOTIPO` ENABLE KEYS */;
UNLOCK TABLES;
